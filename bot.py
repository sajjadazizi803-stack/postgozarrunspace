...
async def training_rules(update, context):
    ...
    await query.edit_message_text(
        ...
        "• فقط کافیه این اکانت رو داخل کانال مقصد ادمین کنی:\n"
        "<code>@egpora_e3</code>\n\n"
        "• ربات هم باید داخل <b>کانال مقصد</b> ادمین باشه و اجازه ارسال پیام داشته باشه.\n\n"
        ...
        "• هر کاربر فقط <b>یک انتقال</b> میتونه ثبت کنه. اگر بعداً خواستی مبدا یا مقصد رو تغییر بدی، از قسمت <b>«📋 کانال‌های ثبت شده»</b> این کار رو انجام بده و دوباره انتقال جدید نساز.\n\n"
        "❗ اگر مراحل بالا رو درست انجام ندی، انتقال ثبت نمیشه یا پیام‌ها منتقل نخواهند شد.\n\n"
        "• بعد از ثبت انتقال، از قسمت <b>«📋 کانال‌های ثبت شده»</b> میتونی انتقالت رو مدیریت کنی، مبدا یا مقصد رو تغییر بدی، انتقال رو متوقف یا فعال کنی و تنظیماتش رو تغییر بدی.\n\n"
