...
async def training_rules(update, context):
    ...
    await query.edit_message_text(
        ...
        "❗ اگر این مراحل رو اشتباه انجام بدی، انتقال ثبت نمیشه یا ربات درست کار نمیکنه.\n\n"
        "• بعد از ثبت انتقال، از قسمت <b>«📋 کانال‌های ثبت شده»</b> میتونی انتقال‌هات رو مدیریت کنی و از بخش <b>«⚙️ تنظیمات»</b> تنظیمات هر انتقال رو تغییر بدی.",
